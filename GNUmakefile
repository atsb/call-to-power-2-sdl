...
am__configure_deps = $(am__aclocal_m4_deps) $(CONFIGURE_DEPENDENCIES) \
	$(ACLOCAL_M4)
DIST_COMMON = $(srcdir)/GNUmakefile.am $(top_srcdir)/configure \
...
am__DIST_COMMON = $(srcdir)/GNUmakefile.in \
	$(top_srcdir)/ctp2_code/os/autoconf/config/compile \
	$(top_srcdir)/ctp2_code/os/autoconf/config/config.guess \
	$(top_srcdir)/ctp2_code/os/autoconf/config/config.sub \
	$(top_srcdir)/ctp2_code/os/autoconf/config/install-sh \
	$(top_srcdir)/ctp2_code/os/autoconf/config/ltmain.sh \
	$(top_srcdir)/ctp2_code/os/autoconf/config/missing \
	$(top_srcdir)/ctp2_code/os/include/config.h.in README.md \
	ctp2_code/os/autoconf/config/compile \
...
YFLAGS = -d -v
_BFR_ = 
abs_builddir = /home/wq108/Downloads/ctp2-mainfff/ctp2-main
abs_srcdir = /home/wq108/Downloads/ctp2-mainfff/ctp2-main
...
ctp2_code/os/include/config.h: ctp2_code/os/include/stamp-h1
	@test -f $@ || rm -f ctp2_code/os/include/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) ctp2_code/os/include/stamp-h1

ctp2_code/os/include/stamp-h1: $(top_srcdir)/ctp2_code/os/include/config.h.in $(top_builddir)/config.status
	@rm -f ctp2_code/os/include/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status ctp2_code/os/include/config.h
$(top_srcdir)/ctp2_code/os/include/config.h.in: # $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f ctp2_code/os/include/stamp-h1
	touch $@

distclean-hdr:
	-rm -f ctp2_code/os/include/config.h ctp2_code/os/include/stamp-h1
