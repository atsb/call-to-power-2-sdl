...
void DiplomacyProposalRecord::Init()
{
    m_flags0 = 0;
    m_Title = 0;
    m_Category = 0;
...
void DiplomacyProposalRecord::Serialize(CivArchive &archive)
{
    if(archive.IsStoring()) {
        ...
        archive << m_Type;
        archive << m_Arg1;
        m_Details0Value.Serialize(archive);
        m_Details1Value.Serialize(archive);
        m_Details2Value.Serialize(archive);
        m_Details3Value.Serialize(archive);
        m_Details4Value.Serialize(archive);
        m_DetailsEx0Value.Serialize(archive);
        m_DetailsEx1Value.Serialize(archive);
        m_DetailsEx2Value.Serialize(archive);
        m_DetailsEx3Value.Serialize(archive);
        m_DetailsEx4Value.Serialize(archive);
        archive << m_Class;
        archive << m_Excludes;
        archive << m_ReciprocalValue;
        archive << m_Image;
        archive << m_ImageSlotValue;
    } else {
        //GovMod Specific flag initialization
        m_hasGovernmentsModified = false;
        ...
        archive >> m_Arg1;
        memset((uint8*)&m_Details0Value, 0, sizeof(m_Details0Value));
        m_Details0Value.Serialize(archive);
        memset((uint8*)&m_Details1Value, 0, sizeof(m_Details1Value));
        m_Details1Value.Serialize(archive);
        memset((uint8*)&m_Details2Value, 0, sizeof(m_Details2Value));
        m_Details2Value.Serialize(archive);
        memset((uint8*)&m_Details3Value, 0, sizeof(m_Details3Value));
        m_Details3Value.Serialize(archive);
        memset((uint8*)&m_Details4Value, 0, sizeof(m_Details4Value));
        m_Details4Value.Serialize(archive);
        memset((uint8*)&m_DetailsEx0Value, 0, sizeof(m_DetailsEx0Value));
        m_DetailsEx0Value.Serialize(archive);
        memset((uint8*)&m_DetailsEx1Value, 0, sizeof(m_DetailsEx1Value));
        m_DetailsEx1Value.Serialize(archive);
        memset((uint8*)&m_DetailsEx2Value, 0, sizeof(m_DetailsEx2Value));
        m_DetailsEx2Value.Serialize(archive);
        memset((uint8*)&m_DetailsEx3Value, 0, sizeof(m_DetailsEx3Value));
        m_DetailsEx3Value.Serialize(archive);
        memset((uint8*)&m_DetailsEx4Value, 0, sizeof(m_DetailsEx4Value));
        m_DetailsEx4Value.Serialize(archive);
        archive >> m_Class;
        archive >> m_Excludes;
        archive >> m_ReciprocalValue;
...
DiplomacyProposalRecord const & DiplomacyProposalRecord::operator = (DiplomacyProposalRecord const & rval)
{
    if (this != &rval)
    {
...
const char *g_DiplomacyProposal_Tokens[] =
{
    "Title",
    "Category",
    "Type",
...
DiplomacyProposalRecordAccessorInfo g_DiplomacyProposalRecord_Accessors[] =
{
    ...
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details0 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details0 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details1 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details1 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details2 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details2 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details3 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details3 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details4 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Details4 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx0 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx0 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx1 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx1 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx2 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx2 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx3 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx3 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx4 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* DetailsEx4 */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Class */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Excludes */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Reciprocal */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Reciprocal */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Image */
    { NULL, NULL, NULL, &DiplomacyProposalRecord::GetImageSlot, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* ImageSlot */
    { NULL, &DiplomacyProposalRecord::GetDisabled, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasAlly, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasBorderIncursion, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetIsPirating, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasEmbassy, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasHotwar, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetNoHotwar, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasPeaceTreaty, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasAlliance, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasNuclearWeapons, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasBioWeapons, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasNanoWeapons, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasEmbargo, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasMilitaryAgreement, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasPollutionAgreement, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetHasPollution, NULL, NULL, NULL, NULL, NULL },
    { NULL, &DiplomacyProposalRecord::GetTrustViolationGlobal, NULL, NULL, NULL, NULL, NULL },
};
...
sint32 DiplomacyProposalRecord::Parse(DBLexer *lex, sint32 numRecords)
{
    bool done = false;
    sint32 result = 0;
    sint32 tok;
    ...
    if(tok != k_Token_Name) {
        char newName[256];
        sprintf(newName, "DIPLOMACYPROPOSAL_%i", numRecords);
    ...
    while(!done) {
        ...
        switch(tok) {
            ...
            case k_Token_DiplomacyProposal_Reciprocal:
                ...
                if(!g_theDiplomacyProposalDB->GetRecordFromLexer(lex, m_ReciprocalValue)) {
...
DiplomacyProposalRecord::StrengthStrings const & DiplomacyProposalRecord::StrengthStrings::operator = (StrengthStrings const & rval)
{
    if (this != &rval)
    {
        m_flags0 = rval.m_flags0;
...
void DiplomacyProposalRecord::StrengthStrings::Serialize(CivArchive &archive)
{
    if(archive.IsStoring()) {
        archive << m_flags0;
        if (HasDetailsWeak()){
            MBCHAR* tmpString = g_theStringDB->GetIdStr(m_DetailsWeakValue);
            archive << tmpString;
        }

        if (HasDetailsEven()){
            MBCHAR* tmpString = g_theStringDB->GetIdStr(m_DetailsEvenValue);
            archive << tmpString;
        }

        if (HasDetailsStrong()){
            MBCHAR* tmpString = g_theStringDB->GetIdStr(m_DetailsStrongValue);
            archive << tmpString;
        }
        ...
        archive >> m_flags0;
        {
            if (HasDetailsWeak()){
                MBCHAR* tmpString = NULL;
                archive >> tmpString;
                g_theStringDB->GetStringID(tmpString, m_DetailsWeakValue);
                delete[] tmpString;
            }
        }

        {
            if (HasDetailsEven()){
                MBCHAR* tmpString = NULL;
                archive >> tmpString;
                g_theStringDB->GetStringID(tmpString, m_DetailsEvenValue);
                delete[] tmpString;
            }
        }

        {
            if (HasDetailsStrong()){
                MBCHAR* tmpString = NULL;
                archive >> tmpString;
                g_theStringDB->GetStringID(tmpString, m_DetailsStrongValue);
                delete[] tmpString;
            }
        }
...
static const char *s_DiplomacyProposal_StrengthStrings_Tokens[] = {
    "DetailsWeak",
    "DetailsEven",
    "DetailsStrong",
};
...
static const char *s_DiplomacyProposal_Category_BitNames[] = {
    "Request",
    "Treaty",
    "Gift",
};
...
static const char *s_DiplomacyProposal_Arg1_BitNames[] = {
    "OwnCity",
    "HisCity",
    "OwnArmy",
    "HisArmy",
...
static const char *s_DiplomacyProposal_Class_BitNames[] = {
    "Request",
    "Treaty",
    "Offer",
};
...
static const char *s_DiplomacyProposal_Excludes_BitNames[] = {
    "Request",
    "Treaty",
    "Offer",
};
...
void DiplomacyProposalRecord::Merge(const DiplomacyProposalRecord & rval){
    ...
    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_Details0_Bit)
    {
        m_Details0Value = rval.m_Details0Value;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_Details1_Bit)
    {
        m_Details1Value = rval.m_Details1Value;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_Details2_Bit)
    {
        m_Details2Value = rval.m_Details2Value;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_Details3_Bit)
    {
        m_Details3Value = rval.m_Details3Value;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_Details4_Bit)
    {
        m_Details4Value = rval.m_Details4Value;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_DetailsEx0_Bit)
    {
        m_DetailsEx0Value = rval.m_DetailsEx0Value;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_DetailsEx1_Bit)
    {
        m_DetailsEx1Value = rval.m_DetailsEx1Value;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_DetailsEx2_Bit)
    {
        m_DetailsEx2Value = rval.m_DetailsEx2Value;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_DetailsEx3_Bit)
    {
        m_DetailsEx3Value = rval.m_DetailsEx3Value;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_DetailsEx4_Bit)
    {
        m_DetailsEx4Value = rval.m_DetailsEx4Value;
    }
    ...
    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_Reciprocal_Bit)
    {
        m_ReciprocalValue = rval.m_ReciprocalValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_DiplomacyProposal_ImageSlot_Bit)
    {
        m_ImageSlotValue = rval.m_ImageSlotValue;
    }
...
DiplomacyProposalRecord const * DiplomacyProposalRecord::GetReciprocalPtr() const
{
