...
void EndGameObjectRecord::Init()
{
    ...
    m_MinRadiusValue = 0;
    m_MaxRadiusValue = 0;
    m_MinCoverageValue = 0.000000;
    m_TurnsToActivateValue = 0;
    //GovMod Specific flag initialization
    m_hasGovernmentsModified = false;
}

void EndGameObjectRecord::Serialize(CivArchive &archive)
{
    if(archive.IsStoring()) {
        ...
        archive << m_flags0;
        archive << m_WonderValue;
        archive << m_BuildingValue;
        archive << m_TerrainImprovementValue;
        archive << m_MinNeededValue;
        archive << m_MaxNeededValue;
        archive << m_PowerSourceValue;
        archive << m_MinRadiusValue;
        archive << m_MaxRadiusValue;
        archive << m_MinCoverageValue;
        archive << m_TurnsToActivateValue;
    } else {
        //GovMod Specific flag initialization
        m_hasGovernmentsModified = false;
...
EndGameObjectRecord const & EndGameObjectRecord::operator = (EndGameObjectRecord const & rval)
{
    if (this != &rval)
    {
...
const char *g_EndGameObject_Tokens[] =
{
    "Wonder",
    "WonderValue",
    "Building",
...
{
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Wonder */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Wonder */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Building */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Building */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* TerrainImprovement */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* TerrainImprovement */
    { NULL, NULL, NULL, &EndGameObjectRecord::GetMinNeeded, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* MinNeeded */
    { NULL, NULL, NULL, &EndGameObjectRecord::GetMaxNeeded, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* MaxNeeded */
    { NULL, &EndGameObjectRecord::GetIsSatellite, NULL, NULL, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* PowerSource */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* PowerSource */
    { NULL, NULL, NULL, &EndGameObjectRecord::GetMinRadius, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* MinRadius */
    { NULL, NULL, NULL, &EndGameObjectRecord::GetMaxRadius, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* MaxRadius */
    { NULL, NULL, NULL, NULL, &EndGameObjectRecord::GetMinCoverage, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* MinCoverage */
    { NULL, NULL, NULL, &EndGameObjectRecord::GetTurnsToActivate, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* TurnsToActivate */
};
...
sint32 EndGameObjectRecord::Parse(DBLexer *lex, sint32 numRecords)
{
    bool done = false;
    sint32 result = 0;
    sint32 tok;
    ...
    if(tok != k_Token_Name) {
        char newName[256];
        sprintf(newName, "ENDGAMEOBJECT_%i", numRecords);
    ...
    while(!done) {
        ...
        switch(tok) {
            case k_Token_EndGameObject_Wonder:
                ...
                if(!g_theWonderDB->GetRecordFromLexer(lex, m_WonderValue)) {
            ...
            case k_Token_EndGameObject_Building:
                ...
                if(!g_theBuildingDB->GetRecordFromLexer(lex, m_BuildingValue)) {
                    DBERROR(("Expected record"));
                    done = true; break;
                }
                break;
            case k_Token_EndGameObject_TerrainImprovement:
                ...
                if(!g_theTerrainImprovementDB->GetRecordFromLexer(lex, m_TerrainImprovementValue)) {
                    DBERROR(("Expected record"));
                    done = true; break;
                }
                break;
            ...
            case k_Token_EndGameObject_PowerSource:
                ...
                if(!g_theEndGameObjectDB->GetRecordFromLexer(lex, m_PowerSourceValue)) {
                    DBERROR(("Expected record"));
                    done = true; break;
                }
                break;
...
void EndGameObjectRecord::Merge(const EndGameObjectRecord & rval){
    ...
    if (rval.m_flags0 & k_EndGameObject_Wonder_Bit)
    {
        m_WonderValue = rval.m_WonderValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_EndGameObject_Building_Bit)
    {
        m_BuildingValue = rval.m_BuildingValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_EndGameObject_TerrainImprovement_Bit)
    {
        m_TerrainImprovementValue = rval.m_TerrainImprovementValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_EndGameObject_MinNeeded_Bit)
    {
        m_MinNeededValue = rval.m_MinNeededValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_EndGameObject_MaxNeeded_Bit)
    {
        m_MaxNeededValue = rval.m_MaxNeededValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_EndGameObject_PowerSource_Bit)
    {
        m_PowerSourceValue = rval.m_PowerSourceValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_EndGameObject_MinRadius_Bit)
    {
        m_MinRadiusValue = rval.m_MinRadiusValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_EndGameObject_MaxRadius_Bit)
    {
        m_MaxRadiusValue = rval.m_MaxRadiusValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_EndGameObject_MinCoverage_Bit)
    {
        m_MinCoverageValue = rval.m_MinCoverageValue;
    }

    // only replace values that have been set
    if (rval.m_flags0 & k_EndGameObject_TurnsToActivate_Bit)
    {
        m_TurnsToActivateValue = rval.m_TurnsToActivateValue;
    }
...
WonderRecord const * EndGameObjectRecord::GetWonderPtr() const
{
    return g_theWonderDB->Get(m_WonderValue);
}

BuildingRecord const * EndGameObjectRecord::GetBuildingPtr() const
{
    return g_theBuildingDB->Get(m_BuildingValue);
}

TerrainImprovementRecord const * EndGameObjectRecord::GetTerrainImprovementPtr() const
{
    return g_theTerrainImprovementDB->Get(m_TerrainImprovementValue);
}

EndGameObjectRecord const * EndGameObjectRecord::GetPowerSourcePtr() const
{
