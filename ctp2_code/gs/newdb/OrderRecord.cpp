...
void OrderRecord::Init()
{
    ...
    m_Cursor = 0;
    m_InvalidCursor = 0;
    m_FailSound = 0x7fffffff;
    m_Sound = 0x7fffffff;
    //GovMod Specific flag initialization
    m_hasGovernmentsModified = false;
}

void OrderRecord::Serialize(CivArchive &archive)
{
    if(archive.IsStoring()) {
        ...
        archive << m_EventName;
        {
            MBCHAR* tmpString = g_theStringDB->GetIdStr(m_LocalizedName);
            archive << tmpString;
        }

        {
            MBCHAR* tmpString = g_theStringDB->GetIdStr(m_StatusText);
            archive << tmpString;
        }

        archive << m_TargetPretest;
        archive << m_RangeValue;
        archive << m_CPIcon;
        archive << m_DefaultIcon;
        archive << m_ButtonLocation;
        archive << m_Cursor;
        archive << m_InvalidCursor;
        archive << m_FailSound;
        archive << m_Sound;
    } else {
        //GovMod Specific flag initialization
...

        {
            ...
            archive >> tmpString;
            g_theStringDB->GetStringID(tmpString, m_LocalizedName);
            delete[] tmpString;
        }

        {
            MBCHAR* tmpString = NULL;
            archive >> tmpString;
            g_theStringDB->GetStringID(tmpString, m_StatusText);
            delete[] tmpString;
        }
...
OrderRecord const & OrderRecord::operator = (OrderRecord const & rval)
{
    if (this != &rval)
    {
...
const char *g_Order_Tokens[] =
{
    ...
    "UnitPretest_NoFuelThenCrash",
    "UnitPretest_CanParadrop",
    "UnitPretest_CanAirlift",
    "UnitPretest_CanRebase",
...
{
    { &OrderRecord::GetGold, NULL, NULL, NULL, NULL, NULL, NULL },
    { &OrderRecord::GetMove, NULL, NULL, NULL, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* EventName */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* LocalizedName */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* StatusText */
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* TargetPretest */
    { NULL, &OrderRecord::GetUnitPretest_None, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanAttack, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanEntrench, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanSueFranchise, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanSue, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanCreateFranchise, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanInvestigateCity, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanBombard, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanSettle, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanStealTechnology, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanInciteRevolution, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanAssassinateRuler, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanExpel, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_EstablishEmbassy, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_ThrowParty, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanCauseUnhappiness, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanPlantNuke, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanSlaveRaid, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanEnslaveSettler, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanUndergroundRailway, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanInciteUprising, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanBioTerror, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanPlague, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanNanoInfect, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanConvertCity, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanReformCity, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanSellIndulgences, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanFaithHeal, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanSoothsay, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanCreatePark, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanPillage, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanInjoin, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanInterceptTrade, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanAdvertise, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanNukeCity, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanTransport, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanBeTransported, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanLaunch, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanTarget, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_NoFuelThenCrash, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanParadrop, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanAirlift, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanRebase, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_CanUpgrade, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetUnitPretest_Invalid, NULL, NULL, NULL, NULL, NULL },
    { NULL, NULL, NULL, &OrderRecord::GetRange, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* Range */
    { NULL, &OrderRecord::GetIsTeleport, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetIsTarget, NULL, NULL, NULL, NULL, NULL },
    { NULL, &OrderRecord::GetGLHidden, NULL, NULL, NULL, NULL, NULL },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL }, /* CPIcon */
    { &OrderRecord::GetDefaultIconIndex, NULL, NULL, NULL, NULL, NULL, NULL },
    { &OrderRecord::GetButtonLocation, NULL, NULL, NULL, NULL, NULL, NULL },
    { &OrderRecord::GetCursor, NULL, NULL, NULL, NULL, NULL, NULL },
    { &OrderRecord::GetInvalidCursor, NULL, NULL, NULL, NULL, NULL, NULL },
    { &OrderRecord::GetFailSoundIndex, NULL, NULL, NULL, NULL, NULL, NULL },
    { &OrderRecord::GetSoundIndex, NULL, NULL, NULL, NULL, NULL, NULL },
};
...
#define k_Token_Order_UnitPretest_NoFuelThenCrash ((k_Token_Custom_Base) + 45)
#define k_Token_Order_UnitPretest_CanParadrop    ((k_Token_Custom_Base) + 46)
#define k_Token_Order_UnitPretest_CanAirlift     ((k_Token_Custom_Base) + 47)
#define k_Token_Order_UnitPretest_CanRebase      ((k_Token_Custom_Base) + 48)
#define k_Token_Order_UnitPretest_CanUpgrade     ((k_Token_Custom_Base) + 49)
#define k_Token_Order_UnitPretest_Invalid        ((k_Token_Custom_Base) + 50)
#define k_Token_Order_Range                      ((k_Token_Custom_Base) + 51)
#define k_Token_Order_Range_Value                ((k_Token_Custom_Base) + 52)
#define k_Token_Order_IsTeleport                 ((k_Token_Custom_Base) + 53)
#define k_Token_Order_IsTarget                   ((k_Token_Custom_Base) + 54)
#define k_Token_Order_GLHidden                   ((k_Token_Custom_Base) + 55)
#define k_Token_Order_CPIcon                     ((k_Token_Custom_Base) + 56)
#define k_Token_Order_DefaultIcon                ((k_Token_Custom_Base) + 57)
#define k_Token_Order_ButtonLocation             ((k_Token_Custom_Base) + 58)
#define k_Token_Order_Cursor                     ((k_Token_Custom_Base) + 59)
#define k_Token_Order_InvalidCursor              ((k_Token_Custom_Base) + 60)
#define k_Token_Order_FailSound                  ((k_Token_Custom_Base) + 61)
#define k_Token_Order_Sound                      ((k_Token_Custom_Base) + 62)
#define k_Token_Order_Max                        ((k_Token_Custom_Base) + 63)


static BitArray s_ParsedTokens(63);
...
sint32 OrderRecord::Parse(DBLexer *lex, sint32 numRecords)
{
    bool done = false;
    sint32 result = 0;
    sint32 tok;
    ...
    if(tok != k_Token_Name) {
        char newName[256];
        sprintf(newName, "ORDER_%i", numRecords);
    ...
    while(!done) {
        ...
        switch(tok) {
            ...
            case k_Token_Order_UnitPretest_CanTarget:
                ...
                break;
            case k_Token_Order_UnitPretest_NoFuelThenCrash:
                m_flags1 |= k_Order_UnitPretest_NoFuelThenCrash_Bit;
                break;
            case k_Token_Order_UnitPretest_CanParadrop:
                m_flags1 |= k_Order_UnitPretest_CanParadrop_Bit;
                break;
            case k_Token_Order_UnitPretest_CanAirlift:
                m_flags1 |= k_Order_UnitPretest_CanAirlift_Bit;
                break;
            case k_Token_Order_UnitPretest_CanRebase:
                m_flags1 |= k_Order_UnitPretest_CanRebase_Bit;
                break;
            case k_Token_Order_UnitPretest_CanUpgrade:
                m_flags1 |= k_Order_UnitPretest_CanUpgrade_Bit;
                break;
            ...
            case k_Token_Order_FailSound:
                if (!g_theSoundDB->GetRecordFromLexer(lex, m_FailSound)) {
                    done = true; break;
                }
                break;
...
void OrderRecord::ResolveDBReferences()
{
    ...
    if(m_FailSound & 0x80000000) {
        sint32 id = m_FailSound & 0x7fffffff;
        if(!g_theSoundDB->GetNamedItem(id, m_FailSound)) {
            c3errors_ErrorDialog("DB", "%s not found in Sound database", g_theStringDB->GetNameStr(id));
        }
    } else if(m_FailSound == 0x7fffffff) {
        m_FailSound = -1;
    }
...
static const char *s_Order_TargetPretest_BitNames[] = {
    "None",
    "EnemyCity",
    "OwnCity",
    "EnemyArmy",
...
#define k_Order_TargetPretest_Num_BitNames 14
...
void OrderRecord::Merge(const OrderRecord & rval){
    ...
    if (rval.m_TargetPretest)
    {
        m_TargetPretest = rval.m_TargetPretest;
    }

    // only replace values that have been set
    if (rval.m_flags1 & k_Order_Range_Bit)
    {
        m_RangeValue = rval.m_RangeValue;
    }
...
IconRecord const * OrderRecord::GetDefaultIcon() const
{
    return g_theIconDB->Get(m_DefaultIcon);
}

SoundRecord const * OrderRecord::GetFailSound() const
{
    return g_theSoundDB->Get(m_FailSound);
}

SoundRecord const * OrderRecord::GetSound() const
{
