...
void CityData::MakeFranchise(sint32 player)
{
	...
	ProcessAllResources(); // updates m_productionLostToFranchise which is used for drawing loss on franchise city-icon
}
...
void CityData::ConvertTo(sint32 player, CONVERTED_BY by)
{
	...
	ProcessAllResources(); // updates m_convertedGold which is used for drawing loss on conversion city-icon
}
