...
BOOL				s_windowedModeToggled		= FALSE;
...
AUI_ERRCODE graphicsscreen_Initialize( void )
{
	...
	s_windowedMode	   = spNew_aui_Switch(&errcode, windowBlock, "WindowedButton", graphicsscreen_checkPress, &check[GS_WINDOWED_MODE]);
...
void graphicsscreen_checkPress(aui_Control *control, uint32 action, uint32 data, void *cookie )
{
	...
	case GS_GOODANIMS:
		...
		break;
	case GS_WINDOWED_MODE:
		func = &ProfileDB::SetWindowedMode;
		s_windowedModeToggled = TRUE;
		break;
	case GS_CITYPROD:
